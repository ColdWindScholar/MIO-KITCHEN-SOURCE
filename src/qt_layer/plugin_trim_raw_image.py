...
class TrimRawImageMessageBox(MessageBoxBase):
    def __init__(self, parent=None):
        ...
        self.titleLabel = BodyLabel("Trim Raw Image", self)
    ...
    def open_file_dialog(self):
        ...
        file_path, _ = QFileDialog.getOpenFileName(self, "Select Raw Image File", "", "All Files (*)")
        if file_path:
